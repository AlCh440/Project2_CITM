...
bool PausePanel::Start()
{
	...
	bt_saveGame = (GuiButton*)CreateGuiButton(0, app->guiManager, this, { this->position.x + 555,this->position.y + 240,170,60 }, "Save Game", app->fonts->menuButtonFont, app->fonts->c_Menus);
	...
	bt_settings = (GuiButton*)CreateGuiButton(0, app->guiManager, this, { this->position.x + 555,this->position.y + 330,170,60 }, "Settings", app->fonts->menuButtonFont, app->fonts->c_Menus);
	...
	bt_menu = (GuiButton*)CreateGuiButton(0, app->guiManager, this, { this->position.x + 555,this->position.y + 410,170,60 }, "Main Menu", app->fonts->menuButtonFont, app->fonts->c_Menus);
	...
	bt_quit = (GuiButton*)CreateGuiButton(0, app->guiManager, this, { this->position.x + 555,this->position.y + 500 ,170,60 }, "Quit", app->fonts->menuButtonFont, app->fonts->c_Menus);
